...
compl = network_complex(patp + f'/string_interactions_short_11.5_0.15.tsv', patp + '/DEGs_seurat.csv')
df = pd.DataFrame()
df['node'] = compl.nodes
...
merged_df.to_csv('E:/drug_repurposing/GSE_datesets_results/finished_R_DEG/GSE260711/ph_cocaine_norm_statistics_0.15.csv')
